...
OPENPOSE_PYTHON_PATH = '/home/RVLuser/ferit_ur5_ws/pytorch-openpose'
...
REGISTERED_DEPTH_TOPIC = "/camera/aligned_depth_to_color/image_raw" 
CAMERA_INFO_TOPIC = "/camera/rgb/camera_info"
OPENPOSE_MODEL_FILE = os.path.join(OPENPOSE_PYTHON_PATH, "model", "hand_pose_model.pth")
MODELS_DIR_ROOT = os.path.join(get_project_root(), "models")
...
class LiveGraspDetector:
    def __init__(self, model_type="xgboost"):
        ...
        model_path = '/home/RVLuser/ferit_ur5_ws/src/student/miletic_dr/src/models/xgboost_model.joblib'
        encoder_path = '/home/RVLuser/ferit_ur5_ws/src/student/miletic_dr/src/models/label_encoder_xgboost.joblib'
    ...
    def _process_frame_data(self, rgb_frame_bgr: np.ndarray, depth_frame_mm: np.ndarray):
        print("Processing new frame data...")
...
if __name__ == "__main__":
    detector = LiveGraspDetector(model_type="xgboost")
    detector.run()